...
const styles = StyleSheet.create({
    ...
    monthPicker: {flex: 2, border: 0, position: 'relative', left: -4},
    dayPicker: {flex: 1, border: 0, position: 'relative', left: -4},
    yearPicker: {flex: 2, border: 0, position: 'relative', left: -4},
})
